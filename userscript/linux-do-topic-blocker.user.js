// ==UserScript==
// @name         [LINUX DO] 🚫 屏蔽含有指定：类别、标签和标题关键词 的话题 [20260507] v1.0.0
...
// @update-log   [20260507] v1.0.0 适配总结脚本新增追问按钮，悬浮屏蔽按钮会锚定到总结按钮组最左侧，避免夹在追问与总结按钮之间。
//
...
(function () {
    ...
    const SCRIPT_VERSION = '[20260507] v1.0.0';
    const SCRIPT_NAME = '[LINUX DO] 🚫 屏蔽含有指定：类别、标签和标题关键词 的话题 [20260507] v1.0.0';
    ...
    const SCRIPT_UPDATE_LOG = '[20260507] v1.0.0 适配总结脚本新增追问按钮，悬浮屏蔽按钮会锚定到总结按钮组最左侧，避免夹在追问与总结按钮之间。';
...
`;
    ...
    function getSummaryActionAnchorRect(item) {
    ...
    function resolveBlockActionButtonPosition({
        hostRect,
