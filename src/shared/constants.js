export const SCRIPT_VERSION = '[20260504] v1.0.4';
export const SCRIPT_NAME = '[LINUX DO] 🚫 屏蔽含有指定：类别、标签和标题关键词 的话题 [20260504] v1.0.4';
...
export const SCRIPT_UPDATE_LOG = '[20260504] v1.0.4 修复屏蔽选择器勾选项受站点全局 input 样式影响、取消勾选不稳定，以及取消全部选项后仍兜底屏蔽整条标题的问题。';
